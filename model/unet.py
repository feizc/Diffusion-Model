...
from .utils import avg_pool_nd, conv_nd, linear, normalization, timestep_embedding, zero_module
from .fp16_utils import convert_module_to_f16, convert_module_to_f32
from .transformer import LayerNorm, Transformer, t_convert_module_to_f16
...
class Text2ImUNet(UNetModel):
    ...
    def convert_to_fp16(self):
        ...
        if self.xf_width:
            self.transformer.apply(t_convert_module_to_f16)
